...
ExternalProject_Add(
    ...
    CMAKE_ARGS -DCMAKE_INSTALL_PREFIX=${INSTALL_DIR}
               -DCMAKE_INSTALL_LIBDIR=${LIB_DIR} -DENABLE_SHARED=OFF
               -DENABLE_STATIC=ON ${ARCH_FLAGS}
    BUILD_IN_SOURCE OFF
    CONFIGURE_HANDLED_BY_BUILD ON
    BUILD_BYPRODUCTS "${LIB_PATH}" # Needed for Ninja generator. See
                                   # BUILD_BYPRODUCTS docs for details.
)

# This needs to be created immediately, otherwise top-level project generation
# will fail. It will be populated by the install step of the external project.
