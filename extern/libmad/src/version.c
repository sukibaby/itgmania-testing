...
// NOTE: Extra spaces for mad_version are for ABI compatibility
...
static const char* mad_version_string = "MPEG Audio Decoder " MAD_VERSION;

const char* mad_version_get_string()
{
    return mad_version_string;
}
