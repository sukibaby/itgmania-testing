...
target_compile_definitions(
    "tomcrypt" PRIVATE LTC_NO_MACS) # no MAC (message authentication code)
                                    # support
...
# Fixes build failures due to clang warnings See itgmania/itgmania#107 for
# details
...
if(APPLE)
    set_property(TARGET "tomcrypt" PROPERTY XCODE_ATTRIBUTE_GCC_NO_COMMON_BLOCKS
                                            "YES")
endif()
if(MSVC)
