...
if(NOT WIN32)
    ...
    if(PULSEAUDIO_FOUND)
        ...
        # PULSEAUDIO_DEFINITIONS - Compiler switches required for using
        # PulseAudio set(PULSEAUDIO_DEFINITIONS ${PULSEAUDIO_CFLAGS})
...
find_package_handle_standard_args(PULSEAUDIO DEFAULT_MSG PULSEAUDIO_INCLUDE_DIR
                                  PULSEAUDIO_LIBRARY)
