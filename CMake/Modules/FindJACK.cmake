...
if(JACK_LIBRARIES AND JACK_INCLUDE_DIRS)
    ...
    find_path(
        JACK_INCLUDE_DIR
        NAMES jack/jack.h
        PATHS ${_JACK_INCLUDEDIR} /usr/include /usr/local/include
              /opt/local/include /sw/include)

    find_library(
        JACK_LIBRARY
        NAMES jack
        PATHS ${_JACK_LIBDIR} /usr/lib /usr/local/lib /opt/local/lib /sw/lib)
    ...
    find_package_handle_standard_args(JACK DEFAULT_MSG JACK_INCLUDE_DIRS
                                      JACK_LIBRARIES)

    # show the JACK_INCLUDE_DIRS and JACK_LIBRARIES variables only in the
    # advanced view
