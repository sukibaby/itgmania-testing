...
if(CPACK_SYSTEM_NAME STREQUAL "Linux" OR CPACK_SYSTEM_NAME STREQUAL "Linux-arm64" OR CPACK_SYSTEM_NAME STREQUAL "Linux-unknown")
  if(CMAKE_SYSTEM_PROCESSOR STREQUAL "x86_64")
    set(_ARCH "x86_64")
  elseif(CMAKE_SYSTEM_PROCESSOR STREQUAL "aarch64")
    set(_ARCH "aarch64")
  ...
  set(CPACK_PACKAGE_FILE_NAME "${CPACK_PACKAGE_FILE_NAME}-${_ARCH}")
endif()
