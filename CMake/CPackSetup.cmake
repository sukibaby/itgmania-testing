...
if(WIN32)
    ...
    # By setting these install keys manually, The default directory of
    # "StepMania major.minor.patch" is lost. This is currently done to maintain
    # backwards compatibility. However, removing these two will allow for
    # multiple versions of StepMania to be installed relatively cleanly.
    ...
    string(REGEX REPLACE "/" "\\\\\\\\" CPACK_NSIS_MUI_HEADERIMAGE
                         "${CPACK_NSIS_MUI_HEADERIMAGE}")
    string(REGEX REPLACE "/" "\\\\\\\\" CPACK_NSIS_MUI_WELCOMEFINISHPAGE_BITMAP
