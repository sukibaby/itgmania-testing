...
if(APPLE)
    ...
    source_group("OS Specific\\\\Darwin" FILES ${SMDATA_OS_DARWIN_SRC}
                                               ${SMDATA_OS_DARWIN_HPP})
    ...
    if(WIN32)
        ...
        list(
            APPEND
            SMDATA_OS_SRC # TODO: X11 check, crash handler check
...
if(APPLE OR LINUX)
    if(WITH_CRASH_HANDLER)
        ...
        list(
            ...
            "archutils/Unix/SignalHandler.h")
        source_group("OS Specific\\\\Unix" FILES ${SMDATA_OS_UNIX_CRASH_SRC}
                                                 ${SMDATA_OS_UNIX_CRASH_HPP})
