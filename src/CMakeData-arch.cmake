...
source_group("Arch Specific\\\\Threads" FILES ${SMDATA_ARCH_THREADS_SRC}
                                              ${SMDATA_ARCH_THREADS_HPP})

list(APPEND SMDATA_ARCH_SOUND_SRC "arch/Sound/RageSoundDriver.cpp"
...
elseif(APPLE)
    ...
    if(HAS_ALSA)
        list(APPEND SMDATA_ARCH_SOUND_SRC "arch/Sound/ALSA9Dynamic.cpp"
             "arch/Sound/ALSA9Helpers.cpp"
             "arch/Sound/RageSoundDriver_ALSA9_Software.cpp")
        list(APPEND SMDATA_ARCH_SOUND_HPP "arch/Sound/ALSA9Dynamic.h"
             "arch/Sound/ALSA9Functions.h" "arch/Sound/ALSA9Helpers.h"
...
source_group("Arch Specific\\\\Sound" FILES ${SMDATA_ARCH_SOUND_SRC}
                                            ${SMDATA_ARCH_SOUND_HPP})
...
source_group(
    "Arch Specific\\\\Movie Texture" FILES ${SMDATA_ARCH_MOVIE_TEXTURE_SRC}
                                           ${SMDATA_ARCH_MOVIE_TEXTURE_HPP})
...
list(APPEND SMDATA_ARCH_MEMORY_HPP "arch/MemoryCard/MemoryCardDriver.h"
...
source_group("Arch Specific\\\\Memory Card" FILES ${SMDATA_ARCH_MEMORY_SRC}
...
source_group("Arch Specific\\\\Low Level Window"
             FILES ${SMDATA_ARCH_LOWLEVEL_SRC} ${SMDATA_ARCH_LOWLEVEL_HPP})
...
source_group("Arch Specific\\\\Loading Window" FILES ${SMDATA_ARCH_LOADING_SRC}
...
source_group("Arch Specific\\\\Lights" FILES ${SMDATA_ARCH_LIGHTS_SRC}
                                             ${SMDATA_ARCH_LIGHTS_HPP})
...
source_group("Arch Specific\\\\Input Handler" FILES ${SMDATA_ARCH_INPUT_SRC}
                                                    ${SMDATA_ARCH_INPUT_HPP})
...
source_group("Arch Specific\\\\Dialog" FILES ${SMDATA_ARCH_DIALOG_SRC}
...
source_group("Arch Specific\\\\Arch Hooks" FILES ${SMDATA_ARCH_HOOKS_SRC}
