...
add_library("LoadingWindowGtk" OBJECT "arch/LoadingWindow/LoadingWindow_Gtk.cpp"
...
target_include_directories(
    "LoadingWindowGtk"
    PRIVATE "${SM_SRC_DIR}" "${SM_GENERATED_SRC_DIR}"
            "${SM_SRC_DIR}/arch/LoadingWindow" "${GTK3_INCLUDE_DIRS}")

target_link_libraries("LoadingWindowGtk" ${GTK3_LIBRARIES})

list(APPEND SMDATA_LINK_LIB "LoadingWindowGtk")
list(APPEND SMDATA_ARCH_LOADING_HPP "arch/LoadingWindow/LoadingWindow_Gtk.h")
