...
list(APPEND TEXTURE_DAT "${TEXTURE_DIR}/res/Texture Font Generator.ico"
...
add_executable("TextureFontGenerator" WIN32 ${TEXTURE_SRC} ${TEXTURE_HPP}
                                            ${TEXTURE_DAT})
...
list(APPEND TEXTURE_INCLUDE_DIRS "${TEXTURE_DIR}" "${TEXTURE_DIR}/res"
...
set_target_properties(
    "TextureFontGenerator"
    PROPERTIES OUTPUT_NAME "Texture Font Generator"
