...
list(
    ...
    "RageUtil.h"
    "RageUtil_AutoPtr.h" # TODO: Remove the need for this and replace with c++11
                         # smart pointers
...
source_group("Rage\\\\Utils" FILES ${SMDATA_RAGE_UTILS_SRC}
                                   ${SMDATA_RAGE_UTILS_HPP})
...
source_group("Rage\\\\Misc" FILES ${SMDATA_RAGE_MISC_SRC}
                                  ${SMDATA_RAGE_MISC_HPP})
...
source_group("Rage\\\\Graphics" FILES ${SMDATA_RAGE_GRAPHICS_SRC}
                                      ${SMDATA_RAGE_GRAPHICS_HPP})
...
source_group("Rage\\\\File" FILES ${SMDATA_RAGE_FILE_SRC}
                                  ${SMDATA_RAGE_FILE_HPP})
...
source_group("Rage\\\\Sound" FILES ${SMDATA_RAGE_SOUND_SRC}
                                   ${SMDATA_RAGE_SOUND_HPP})
